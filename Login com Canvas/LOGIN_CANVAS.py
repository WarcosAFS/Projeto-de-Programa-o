...
########   VALIDAÇÃO DE CREDENCIAIS ###########################
        ...
        def verificar_usuario():
            ...
            elif Senha != Senhas[Nomes.index(Nome)]:
                messagebox.showerror('Senha inválida', 'A senha informada está incorreta')
            else:
                messagebox.showinfo('Sucesso na autenticação', f'Credenciais validadas com sucesso\nSeja bem-vindo {Nome}!')
        ...
        self.titulo_autenticar_botao = self.canvas.create_text(0,0, text = 'Autenticar', font = ("Arial", "20", "bold"), anchor = 'w')
...
#### BOTAO DE CADASTRO DA TELA DE CADASTRAMENTO
            ...
            titulo_cadastrar_botao = canvas.create_text(0,0, text = 'Cadastrar', font = ("Arial", "20", "bold"), anchor = 'w')
...
##### BOTAO DE CADASTRO DA TELA DE AUTENTICAÇÃO
        ...
        self.titulo_cadastrar_botao = self.canvas.create_text(0,0, text = 'Cadastrar', font = ("Arial", "20", "bold"), anchor = 'w')
