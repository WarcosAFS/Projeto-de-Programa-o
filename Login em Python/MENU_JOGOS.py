...
class Menu:
    def __init__(self, master=None):
        ...
        self.plaquinha_botao_acertando_alvo = self.canvas.create_image(200, 130, image=self.photo_plaquinha,
                                                                       anchor='nw')
        ...
        self.desconectar_button = Button(master, font=self.fonte_botoes, text='Desconectar', command=desconectar,
                                         bg='#A67242', width=142, height=62)
        self.desconectar_botao = self.canvas.create_window(450, 580, window=self.desconectar_button, width=142,
                                                           height=62, anchor='nw')
