...
class Menu:
    def __init__(self, master=None):
        ...
        self.caminho_acertando_o_alvo = os.path.join(self.diretorio_atual, 'Jogos/acertando_alvo.py')
        self.caminho_desenho_grafico = os.path.join(self.diretorio_atual, 'Jogos/desenho_grafico.py')

        #########     IMAGENS PARA PERSONALIZAÇÃO   ################

        ##### BACKGROUND
        self.caminho_imagem_background = os.path.join(self.diretorio_atual, 'Imagens/menu_fundo.jpg')
        ...
        ##### PLAQUINHA
        self.caminho_imagem_plaquinha = os.path.join(self.diretorio_atual, 'Imagens/plaquinha.png')
        ...
        self.plaquinha = ImageTk.PhotoImage(self.imagem_plaquinha_resized)

        #####    TITULO     ############
        self.titulo_bg = self.canvas.create_rectangle(-2, 35, 652, 85, fill='#A67242')
        self.titulo = self.canvas.create_text(300, 35, text='Escolha um programa', font=('Arial', '30', 'bold'),
                                              anchor='n')
        ...
        self.plaquinha_botao_acertando_alvo = self.canvas.create_image(200, 130, image=self.plaquinha, anchor='nw')
        ...
        self.plaquinha_desenho_grafico = self.canvas.create_image(200, 240, image=self.plaquinha, anchor='nw')
        ...
        self.desconectar_button = Button(master, font=self.fonte_botoes, text='Desconectar', command=desconectar, bg='#A67242',
                borderwidth= 8, width=142, height=62)
        self.canvas.create_window(450, 580, window=self.desconectar_button, width=142, height=62, anchor='nw')
